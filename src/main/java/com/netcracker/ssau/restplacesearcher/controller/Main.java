...
//            JSONObject main = weatherHistoricalDate.getJSONObject(0).getJSONObject("main");
    ...
    private static String getHistoricalWeatherData(double lat, double lon) throws IOException {
        return performRequest("http://samples.openweathermap.org/data/2.5/history/city?lat=41.85&lon=-87.65&appid=b1b15e88fa797225412429c1c50c122a1);//(http://api.openweathermap.org/data/2.5/history/city?lat=" + lat + "&lon=" + lon + "&" + WEATHER_API_KEY);
//    /data/2.5/weather?lat=46.73&lon=-117&appid=b089342ff727fbb2fc357f71779ba4d3
    }
